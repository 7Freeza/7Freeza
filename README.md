...
|---|---|---|
| [VersaFit](https://github.com/7Freeza/VersaFit) | Hábitos y entrenamiento: rutinas, peso, rachas y plan personalizado. | Node · Express · PostgreSQL · Tailwind |
| [cuadre-iq](https://github.com/7Freeza/cuadre-iq) | Extractor, validador y reconciliador de facturas: PDF/foto → reglas → humano confirma. | Python · PyMuPDF · RapidOCR · React |
| [FeedbackIQ](https://github.com/7Freeza/FeedbackIQ) | Ingesta Excel → tokens exactos → traducción ES→EN local → export y analítica de ahorro. | Python · FastAPI · CTranslate2 |
| [IQ-Academy-Chatbot](https://github.com/7Freeza/IQ-Academy-Chatbot) | Asistente con RAG para una academia de idiomas: embeddings locales + Gemini, streaming. | TypeScript · React · Express · Ollama |
